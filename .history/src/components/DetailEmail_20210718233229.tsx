...
// } 
export default class DetailEmail extends React.Component<EmailCRMProps, EmailCRMState> {
                    ...
                    <Grid item container xs={12} style={classes.containerP} >
                        <Grid item container xs={6}>
                            ...
                            <Grid item container xs={10}>
                                <Grid item xs={12}>{emailCrm.from}</Grid>
...
// export default connect(mapStateToProps, mapDispatchToProps)(DetailEmail);
