...
export default function EmailListRow(email){
    ...
    return (
      <TableRow>
        ...
        <TableCell><Typography className={classes.column}>{email.email.subject}</Typography></TableCell>
        <TableCell><Typography className={classes.column}>{email.email.date}</Typography></TableCell>
      </TableRow>
    );
